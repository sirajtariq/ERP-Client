  ...
  const handleViewClick = async (item) => {
    ...
    try {
      ...
      setViewItem({
        ...
        saleValue:        Number(d.saleValue)        || 0,
        potentialProfit:  Number(d.potentialProfit)  || 0,
        totalInvested:    Number(d.totalInvested)    || 0,
        revenueFromSales: Number(d.revenueFromSales) || 0,
        realizedProfit:   Number(d.realizedProfit)   || 0,
        profitPerUnit:    Number(d.profitPerUnit)    || 0,
